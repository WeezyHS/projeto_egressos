...
export default function CursosAlunosPage() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      {cursosFiltrados.length === 0 ? (<p>Nenhum curso encontrado.</p>) : (<ul className="bg-white rounded shadow divide-y">{cursosFiltrados.map((curso) => (<li key={curso.id} className="p-4">{curso.nome}</li>))}</ul>)}
