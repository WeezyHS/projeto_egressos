  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="sticky top-0 h-screen w-64 bg-white border-r shadow p-4 flex flex-col items-center">
        ...
        <Button onClick={() => router.push('/instituicao')}>Início</Button><br/>
        <Button onClick={() => router.push('/instituicao/gerenciar_cursos')}>Gerenciar Cursos</Button><br/>
        <Button onClick={() => router.push('/instituicao/cursos')}>Cursos</Button><br/>
        <Button onClick={() => router.push('/instituicao/editar_informacoes')}>Editar Informações</Button><br/>
