...
export default function CriarContaEgresso() {
    ...
    const camposVazios = () => {
        if (!fotoPerfil || !nome || !cpf || !senha || !telefone || !cidade || !estado || !pais) {
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.duasColunas}>
                ...
                <div className={styles.campo}>
                    <label className={styles.labNome} htmlFor="nome">Nome completo:*</label>
                    <input className={styles.nome} type="text" id="nome" value={nome} onChange={(e) => setNome(e.target.value)} />
                </div>
                <div className={styles.campo}>
